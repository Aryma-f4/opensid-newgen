...
import LembagaManager from "./Manager"

export const dynamic = "force-dynamic"

export default async function LembagaPage() {
  const [lembaga, masterRef, penduduk] = await Promise.all([
  ...
  return <LembagaManager data={data} masterRef={masterRef} pendudukRef={pendudukRef} />
}
