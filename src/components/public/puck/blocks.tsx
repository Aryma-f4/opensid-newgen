...
export const BLOCK_FIELDS: Record<string, { label: string; fields: any[] }> = {
  ...
  HeroCard: {
    ...
    fields: [
      ...
      { name: "backgroundColor", label: "Warna Latar", type: "text" as const, defaultValue: "#0b3f2a" },
  ...
  Heading: {
    ...
    fields: [
      ...
      { name: "color", label: "Warna Teks", type: "text" as const },
  ...
  Button: {
    ...
    fields: [
      ...
      { name: "bgColor", label: "Warna Latar", type: "text" as const },
      { name: "textColor", label: "Warna Teks", type: "text" as const },
  ...
  Section: {
    ...
    fields: [
      ...
      { name: "background", label: "Warna Latar", type: "text" as const },
  ...
  Icon: {
    ...
    fields: [
      ...
      { name: "color", label: "Warna Ikon", type: "text" as const },
      { name: "bgColor", label: "Warna Latar", type: "text" as const },
  ...
  LoginButton: {
    ...
    fields: [
      ...
      { name: "bgColor", label: "Warna Latar", type: "text" as const, defaultValue: "linear-gradient(135deg,#3daa46,#2b923e)" },
      { name: "textColor", label: "Warna Teks", type: "text" as const, defaultValue: "#fff" },
